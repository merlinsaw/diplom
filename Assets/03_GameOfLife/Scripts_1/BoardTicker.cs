...
public class BoardTicker : MonoBehaviour {
    private BoardCircle board;

	public void Initialize(BoardCircle board) {
        this.board = board;
    }
    ...
    private bool[,] NextGeneration() {
		var nextGeneration = new bool[BoardCircle.SIZE, BoardCircle.SIZE];

		for (int x = 0; x < BoardCircle.SIZE; x++) {
			for (int y = 0; y < BoardCircle.SIZE; y++) {
