...
public class ClippableObject : MonoBehaviour {
    ...
    {
		plane1Position = camPosition.transform.position;//-new Vector3(0,0,79F);
		plane1Rotation = new Vector3(camRotation.transform.rotation.x+90F, camRotation.transform.rotation.y, camRotation.transform.rotation.z);
        ...
        if (clipPlanes >= 1)
        {
			...
			sharedMaterial.SetVector("_planeNorm", camRotation.transform.rotation * Vector3.forward);
        }
